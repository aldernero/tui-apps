module github.com/aldernero/tui-apps/rule30

go 1.20

require (
	github.com/aldernero/gaul v0.0.0-20230402010037-17be5b985b24
...
require (
	...
	github.com/tdewolff/canvas v0.0.0-20220627195642-6566432f4b20 // indirect
